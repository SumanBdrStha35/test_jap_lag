...
class KanjistrokeSteps extends CustomPainter {
  ...
  KanjistrokeSteps({required this.frame, required this.svgPathList});
  ...
  void _drawDashedLine(Canvas canvas, Offset start, Offset end, Paint paint) {
    ...
    final dashedPath = dashPath(
      path,
      dashArray: CircularIntervalList([dashWidth, dashSpace]),
    );
  ...
  @override
  bool shouldRepaint(covariant KanjistrokeSteps oldDelegate) {
    return oldDelegate.frame != frame || oldDelegate.svgPathList != svgPathList;
  }
}
